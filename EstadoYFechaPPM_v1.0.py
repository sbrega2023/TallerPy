...
log=f'C:/Users/aut_rda.TASA/Desktop/Automatismos Python/Modificacion de estado de tareas en PPM SAP/Loggin/LOG_{datetime.datetime.now().strftime("%Y-%m-%d")}.txt'
...
def sapAuto():
	...
	for fila in range(1, len(dataExl)):
		...
		try:#Click al Boton Grabar	
			...
			WebDriverWait(driver,240).until(EC.text_to_be_present_in_element((By.XPATH, '/html/body/table/tbody/tr/td/div/table/tbody/tr/td/div/table/tbody/tr[1]/td/table/tbody/tr/td/div/table/tbody/tr[1]/td/div/div[3]/div/div/div/div/div/table/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr/td/div/table/tbody/tr[1]/td/table/tbody/tr/td/table/tbody/tr/td[2]/div/span/span/span/span'), 'Se han grabado los datos'))
			...
			if(driver.find_element(By.XPATH,"/html/body/div[3]/div")):
				logger.debug('Except: ALGO FALLO EN EL INTENTO DE GRABACION')
				#try:#Intento cerrar del boton
				#	WebDriverWait(driver, 60).until(EC.element_to_be_clickable((By.XPATH, '/html/body/table/tbody/tr/td/div/table/tbody/tr/td/div/table/tbody/tr[1]/td/table/tbody/tr/td/div/table/tbody/tr[3]/td/table/tbody/tr/td[3]/span[2]/div'))).click()
				#	logger.debug('Except: Se cerro el proyecto del boton...')
				#except:
				driver.close()#Forzamos el cierre del proyecto
				logger.debug('Se Forzo el cierre porque fallo la ACCIÓN')
			else:
